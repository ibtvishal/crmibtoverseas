            ...
            <div class="container-fluid">
                <div class="row heading-bg">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Welcome Call Admin</h5>
                    </div>
                    ...
                    <div class="breadcrumb-section col-lg-4 col-sm-8 col-md-4 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><span>Welcome Call Admin</span></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                            ...
                            <select name="country_id" id="country_id" class="select2 form-control" multiple onchange="change_country(this.value)">
                                <?php                       
                                                    ...
                                                    while($clResult = $obj->fetchNextObject($clSql)){ 
                                                        $stateSqls = $obj->query("select * from $tbl_visa_sub_type where country_id='$clResult->id' and  student_show='1'", -1);
                        ...
                        <div class="panel panel-default card-view">
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body" id="change_country">
                                       <?php
                                       $stateSqls = $obj->query("select * from $tbl_visa_sub_type where student_show='1' group by country_id", -1);
                                       while($ress = $obj->fetchNextObject($stateSqls)){
                                        ...
                                        <div class="row">
                                            ...
                                            ?>
                                            <div class="col-md-4">
                                            <input type="checkbox" value="1" onchange="change_status(this, <?=$res1->id?>)" id="chechbox<?=$res1->id?>" <?=$res1->student_show == 1 ? 'checked' : ''?>>    
    ...
    <script>
        function change_country(val){
            ...
            $.ajax({
                method:"POST",
                url:"controller.php",
                data:{country_wise_visa_subtype: selectedValues},
    ...
    <script>
        function change_status(val,id){
            ...
            $.ajax({
                method:"POST",
                url:"controller.php",
                data:{subtype_checkbox: checkbox,id:id},
                success:function(data){
