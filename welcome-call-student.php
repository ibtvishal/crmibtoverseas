...
$_SESSION['whr1'] = '';
$_SESSION['whr2'] = '';
$whr1 = " and c.student_status=1";
$whr2 = " and c.student_status=1";
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Welcome Call Students
                        </h5>
                        <p> (April 2025 Onwards)</p>
                    </div>
                ...
                <form method="post" name="searchfrm" id="searchfrm" action="welcome-call-student.php">
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <div class="panel-wrapper">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control" name="visa_type" id="visa_type"
                                             ...
                                             <option value="1"  <?php if($_REQUEST['visa_type']=='1'){?> selected <?php }?>>Study Visa</option>
                                             <option value="2"  <?php if($_REQUEST['visa_type']=='2'){?> selected <?php }?>>Tourist Visa</option>
                                             <option value="3"  <?php if($_REQUEST['visa_type']=='3'){?> selected <?php }?>>Visitor Visa</option>
                                             <option value="4"  <?php if($_REQUEST['visa_type']=='4'){?> selected <?php }?>>Work Visa</option>
                                             <option value="5"  <?php if($_REQUEST['visa_type']=='5'){?> selected <?php }?>> Spouse Visa</option>
                                         </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="text" name="end_date" id="end_date"
                                                class="form-control" style="height: 36px;"
                                                value="<?php echo $_REQUEST['end_date']; ?>"
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord('Pending')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                   $sqls=$obj->query("select COUNT(a.id) as num_rows from $tbl_visit as a  inner join $tbl_student as c on a.applicant_contact_no=c.student_contact_no or a.applicant_alternate_no=c.student_contact_no or a.applicant_alternate_no=c.alternate_contact or a.applicant_contact_no = c.alternate_contact inner join $tbl_visa_sub_type as d on d.id=a.visa_sub_type where 1=1 and d.student_show=1 and c.welcome_call_status='Pending' and date(c.cdate) > '2025-04-01' $whr1 group by a.id",$debug=-1);
                                                                    echo $obj->numRows($sqls);
                                                                    ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Pending Calls 1</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                ...
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord('Not Completed')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                   $sqls=$obj->query("select COUNT(a.id) as num_rows from $tbl_visit as a inner join $tbl_student as c on a.applicant_contact_no=c.student_contact_no or a.applicant_alternate_no=c.student_contact_no or a.applicant_alternate_no=c.alternate_contact or a.applicant_contact_no = c.alternate_contact inner join $tbl_visa_sub_type as d on d.id=a.visa_sub_type where 1=1 and d.student_show=1 and c.welcome_call_status='Not Completed' and date(c.cdate) > '2025-04-01' $whr1 group by a.id",$debug=-1);
                                                                    echo $obj->numRows($sqls);
                                                                    ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Not Completed Calls 1</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                ...
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord('Completed')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                   $sqls=$obj->query("select COUNT(a.id) as num_rows from $tbl_visit as a inner join $tbl_student as c on a.applicant_contact_no=c.student_contact_no or a.applicant_alternate_no=c.student_contact_no or a.applicant_alternate_no=c.alternate_contact or a.applicant_contact_no = c.alternate_contact inner join $tbl_visa_sub_type as d on d.id=a.visa_sub_type where 1=1 and d.student_show=1 and c.welcome_call_status='Completed' and date(c.cdate) > '2025-04-01' $whr1 group by a.id",$debug=-1);
                                                                    echo $obj->numRows($sqls);
                                                                    ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Completed Calls 1</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
    ...
    <div id="invoiceModel" class="modal fade" role="dialog">
        ...
        var dataTable = $('#ApplicationList').DataTable({
            ...
            "ajax": { 
                url: "welcome-call-student-ajax.php",
                type: "post",
                error: function() {
