				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						  <h5 class="txt-dark">Manage Visit Status</h5>
						</div>
						...
						<div class="breadcrumb-section col-lg-4 col-sm-8 col-md-8 col-xs-12">
						  <ol class=" breadcrumb">
							...
							<li class="active"><span><a href="javascript:void();" onclick="ShowModal();">Add Visit Status</a></span></li>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							 ...
							 <form name="frm" method="post" action="lead-status-del.php" enctype="multipart/form-data">
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php
													$i=1;
													$sql=$obj->query("select * from $tbl_visit_status where 1=1",$debug=-1);
													...
													<tr>
														...
														<td>  <div class="material-switch">
															<input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_visit_status?>"/>
														...
														<td>
															...
															<!-- <a href="visit-status-del.php?id=<?php echo $line->id ?>" value="Delete" type="submit" class="delete_button" onclick="return confirm('Are you sure you want to delete record(s)')" style=" background: transparent;
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<div class="modal-header">
									...
									<h5 class="modal-title" id="exampleModalLabel1">Add Visit Status</h5>
								</div>
...
function ShowModal(){
	$("#exampleModalLabel1").html("Add Visit Status");
	$("#cname").val("");
	$("#id").val("");
...
{	
	$("#exampleModalLabel1").html("Update Visit Status");
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,type:'getVisitStatus'}, //set data
        beforeSend: function () {
        },
...
{	
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,ival:ival,type:'changeVisitStausDisplay'}, //set data
        beforeSend: function () {
        },
        success: function (response) {
        	$("#sess_msg").html("Status successfully updated.");
