												...
												<tbody>
													...
													<tr>
														...
														<td>  <div class="material-switch">
															<input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_policy_category?>"/>
														...
														<td>
															...
															<a href="controller.php?del_policy_id=<?php echo $line->id ?>" value="Delete" type="submit" class="delete_button" onclick="return confirm('Are you sure you want to delete record(s)')" style=" background: transparent;
...
{	
	...
	$.ajax({
        ...
        data: {id:id,type:'getCategory1'}, //set data
        beforeSend: function () {
        },
...
{	
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,ival:ival,type:'changecatDisplayOrder1'}, //set data
        beforeSend: function () {
        },
        success: function (response) {
