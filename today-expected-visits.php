...
if($_REQUEST['filter_start_date'] && $_REQUEST['filter_end_date']){
  ...
  $whr .= " and date(a.management_datetime) >= '$filter_start_date' and date(a.management_datetime) <= '$filter_end_date'";
    ...
    $whr .= " and (DATE(a.management_datetime) = '".date('Y-m-d')."')";
}
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Manage Today Expected Visits
                ...
                <form method="post" name="searchfrm" id="searchfrm" action="today-expected-visits.php">
                    <div class="row">
                        <div class="col-sm-12">
    ...
    var dataTable = $('#ApplicationList').DataTable({
        ...
        "ajax": {
            url: "today-expected-visits-ajax.php",
            type: "post",
            error: function() {
