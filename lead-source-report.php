            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Manage Lead Source Report
                ...
                <form method="post" name="searchfrm" id="searchfrm" action="lead-source-report.php">
                    <div class="row">
                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Leads</span>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Youtube' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                                ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Total Youtube Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Facebook' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Facebook Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Instagram' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Instagram Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Goggle' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Goggle Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Hoarding/Banner' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Hoarding/Banner Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Friends' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Friends Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Paper Ad' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Paper Ad Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Seminar' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Seminar Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span >
                                                                <?php
                                                                $obj->query("select COUNT(id) as num_rows from $tbl_lead where 1=1 and source='Other' $whr",$debug=-1);
                                                                $line1=$obj->fetchNextObject($sql);
                                                                echo $yt_lead = $line1->num_rows; 
                                                                $pr = ($yt_lead / $totallead)*100;
                                                                echo '<br>('.number_format($pr,2).'%)';
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Total Other Leads</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
