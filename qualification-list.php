				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Manage Qualification</h5>
						</div>
						...
						<div class="breadcrumb-section col-lg-4 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span><a href="javascript:void();" onclick="ShowModal();">Add Qualification</a></span></li>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php
													$i=1;
													$sql=$obj->query("select * from $tbl_qualification where 1=1",$debug=-1);
													while($line=$obj->fetchNextObject($sql)){?>
													<tr>
														<td><?php echo $line->id ?></td>
														<td><?php echo $line->name ?></td>
														<td>  <div class="material-switch">
															<input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_qualification?>"/>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<div class="modal-header">
									...
									<h5 class="modal-title" id="exampleModalLabel1">Add Qualification</h5>
								</div>
...
function ShowModal(){
	$("#exampleModalLabel1").html("Add Qualification");
	$("#cname").val("");
	$("#id").val("");
...
{	
	$("#exampleModalLabel1").html("Update Qualification");
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,type:'getQualification'}, //set data
        beforeSend: function () {
        },
