...
if($_REQUEST['status']){
  ...
  elseif($status==2){
    $whr =" and (date(followup1_start_date) between '$fromdate' and  '$todate' and followup1_remarks!=0 and support_followup1_additional_remarks is null)";
  }
  elseif($status==3){
    $whr =" and (date(followup2_start_date) between '$fromdate' and  '$todate' and followup2_remarks!=0 and support_followup2_additional_remarks is null)";
  }
  elseif($status==4){
    $whr =" and (date(followup3_start_date) between '$fromdate' and  '$todate' and followup3_remarks!=0 and support_followup3_additional_remarks is null)";
  }
  elseif($status==5){
    $whr =" and (date(last_followup_start_date) between '$fromdate' and  '$todate' and last_followup_remarks!=0 and support_last_followup_additional_remarks is null)";
  }else{
      $whr=" and ((date(followup3_start_date) between '$fromdate' and  '$todate' and followup1_remarks!=0 and support_followup1_additional_remarks is null  ) 
...
if($_SESSION['level_id'] == 4){
  ...
  $whr .= " and councellor_id=$councellor_id";
  $whr1 .= " and councellor_id=$councellor_id";
}
...
if($_REQUEST['country_id']){
  ...
  $whr .= " and pre_country_id=$country_id";
  $whr1 .= " and pre_country_id=$country_id";
}

if($_REQUEST['councellor_id']){
  $councellor_id = $_REQUEST['councellor_id'];
  $whr .= " and councellor_id in ($councellor_id)";
  $whr1 .= " and councellor_id in ($councellor_id)";
}

if($_REQUEST['telecaller_id']){
  $telecaller_id = $_REQUEST['telecaller_id'];
  $whr .= " and telecaller_id in ($telecaller_id)";
  $whr1 .= " and telecaller_id in ($telecaller_id)";
}
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Manage Followup Visits</h5>
                    </div>
                ...
                <form method="post" name="searchfrm" id="searchfrm" action="followup-visit-list.php">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <select name="country_id" id="country_id" class="form-control">
                                                ...
                                                <?php                       
                          $clSql = $obj->query("select * from $tbl_country where status=1 order by name");
                                                ...
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(6)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                              $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1 $whr and ((inital_status=8 and followup1_status=0 ) OR (followup1_status=8 and followup2_status =0 )  OR (followup2_status=8 and  followup3_status =0 ) OR (followup3_status=8 and  last_followup_status =0 ))",$debug=-1);
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(7)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                              $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1  $whr and ((inital_status=9 and followup1_status=0 ) OR (followup1_status=9 and followup2_status =0 )  OR (followup2_status=9 and  followup3_status =0 ) OR (followup3_status=9 and  last_followup_status =0 ))",$debug=-1);
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(8)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                              $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1 $whr and ((inital_status=3 and followup1_status=0 ) OR (followup1_status=3 and followup2_status =0 )  OR (followup2_status=3 and  followup3_status =0 ) OR (followup3_status=3 and  last_followup_status =0 ))",$debug=-1);
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(9)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                              $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1 $whr and ((inital_status=4 and followup1_status=0 ) OR (followup1_status=4 and followup2_status =0 )  OR (followup2_status=4 and  followup3_status =0 ) OR (followup3_status=4 and  last_followup_status =0 ))",$debug=-1);
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                               $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1 $whr1 and date(inital_start_date) between '$fromdate' and  '$todate' and inital_remarks!=0 and support_inital_additional_remarks is null",$debug=-1);
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(2)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                               $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1 $whr1 and date(followup1_start_date) between '$fromdate' and  '$todate' and followup1_remarks!=0 and support_followup1_additional_remarks is null",$debug=-1);
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(3)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php                              
                               $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1 $whr1 and date(followup2_start_date) between '$fromdate' and  '$todate' and followup2_remarks!=0 and support_followup2_additional_remarks is null",$debug=-1);
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(4)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                               $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1 $whr1 and date(followup3_start_date) between '$fromdate' and  '$todate' and followup3_remarks!=0 and support_followup3_additional_remarks is null ",$debug=-1);
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord(5)">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                               $obj->query("select COUNT(id) as num_rows from $tbl_visit where 1=1 $whr1 and date(last_followup_start_date) between '$fromdate' and  '$todate' and last_followup_remarks!=0 and support_last_followup_additional_remarks is null ",$debug=-1);
                              $line13=$obj->fetchNextObject($sql);
                              echo $line13->num_rows;
                              ?>
                                                            </span></span>
