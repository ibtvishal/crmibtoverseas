                ...
                <div class="row heading-bg">
                    ...
                    <div class="breadcrumb-section col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <span><a>UK Visa Approved Students</a></span>
                            </li>
                        </ol>
                    </div>
                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">Visa Approved Students</span>
                                                    </a>
                                                </div>
                                ...
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="submit_data('Done')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.enrollment_status='Done' $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span
                                                            class="weight-500 uppercase-font block font-13">Enrollment Done</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                ...
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="submit_data('Not Done')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.enrollment_status='Not Done' $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Enrollment Not Done</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
