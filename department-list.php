				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						  <h5 class="txt-dark">Manage Department</h5>
						</div>
						...
						<div class="breadcrumb-section col-lg-4 col-sm-8 col-md-8 col-xs-12">
						  <ol class=" breadcrumb">
							...
							<li class="active"><span><a href="javascript:void();" onclick="ShowModal();">Add Department</a></span></li>
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td><input type="text" size="5" maxlength="2" value="<?php echo $line->displayorder ?>" onkeyup="chagnedisplayOrder(<?php echo $line->id; ?>,this.value)"></td>
														<td>  <div class="material-switch">
															<input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_department?>"/>
														...
														<td>
															...
															<a href="controller.php?department_del_id=<?php echo $line->id ?>" value="Delete" type="submit" class="delete_button" onclick="return confirm('Are you sure you want to delete record(s)')" style=" background: transparent;
...
function ShowModal(){
	$("#exampleModalLabel1").html("Add Department");
	$("#cname").val("");
	$("#id").val("");
...
{	
	$("#exampleModalLabel1").html("Update Department");
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,type:'getdepartment'}, //set data
        beforeSend: function () {
        },
...
$("#err_category_name").hide();
    ...
    function chagnedisplayOrder(id,val) {
        ...
        $.ajax({
            ...
            url: 'controller.php',
            data: {
                chagnedisplayOrderdepartment: id,
                val: val
            },
            success: function(response) {
