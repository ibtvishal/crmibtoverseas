...
while($line=$obj->fetchNextObject($query)) { 
    ...
    $get_welcome_call_count = $obj->numRows($obj->query("SELECT * FROM $tbl_welcome where stu_id='{$line->stu_id}'"));
