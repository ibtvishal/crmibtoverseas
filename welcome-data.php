...
if(isset($_POST['today_performance'])){
    ...
    $condition1 .= "";
    $condition2 .= "";
                    if($_SESSION['level_id'] == 4 || $_SESSION['level_id'] == 19){
                        $condition = " and date(a.cdate)='$today_date'";
                        $condition1 = " and date(b.cdate)='$today_date'";
                        $condition2 = " and date(a.enrollment_counselor_date)='$today_date'";
                        ...
                        ?>
<div class="row">
    <h5 style="text-align: center;text-decoration: underline; margin-bottom: 10px;">Today’s
        <?=$_SESSION['level_id'] == 19 ? 'Branch ': ''?>Performance</h5>
    <?php
                            ...
                            <div class="row">
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                <?php
                                                                        $appsql1 = $obj->query("select count(a.id) as num_rows from $tbl_visit as a inner join $tbl_visit_fee as b on a.id=b.visit_id where 1=1 and b.payment_type='Registration' $condition1",$debug=-1);
                                                                        $linem1=$obj->fetchNextObject($appsql1);
                                                                        echo $linem1->num_rows;
                                                                        ?>
                                            </span></span>
                                        <span class="weight-500 uppercase-font block font-13">Registrations</span>
                                    </a>
                                </div>
                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                    <i class="icon-user-following data-right-rep-icon txt-light-grey"></i>
                            ...
                            <div class="row">
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                <?php
                                                                        $appsql1 = $obj->query("select count(a.id) as num_rows from $tbl_visit as a where 1=1 and status=0  $condition2",$debug=-1);
                                                                        $linem1=$obj->fetchNextObject($appsql1);
                                                                        echo $linem1->num_rows;
                                                                        ?>
                                            </span></span>
...
<?php if($_SESSION['level_id'] == 9){ ?>
<div class="row">
    <h5 style="text-align: center;text-decoration: underline; margin-bottom: 10px;">Today’s Performance</h5>
                                ...
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="">
                                                <?php
                                                                $total = 0;
                                                                        $appsql1 = $obj->query("select COUNT(a.id) as total,a.branch_id from $tbl_lead as a where 1=1 and a.crm_executive_id='".$_SESSION['sess_admin_id']."' and date(a.cdate) = '$today_date' group by a.branch_id",$debug=-1);
                                                                        ?>
                                            </span></span>
                                        <span class="weight-500 uppercase-font block font-13">Leads</span>
                                    </a>
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="">
                                                <?php
                                                                        $appsql1 = $obj->query("select COUNT(a.id) as total,a.branch_id from $tbl_lead as a where 1=1 and date(a.cdate) = '$today_date' group by a.branch_id",$debug=-1);
                                                                        ?>
                                            </span></span>
                                        <span class="weight-500 uppercase-font block font-13">Leads</span>
                                    </a>
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="">
                                                <?php
                                                                        $appsql1 = $obj->query("select COUNT(a.id) as total,a.branch_id from $tbl_visit as a where 1=1 and date(a.cdate) = '$today_date' group by a.branch_id",$debug=-1);
                                                                        ?>
                                            </span></span>
                                        <span class="weight-500 uppercase-font block font-13">Visits</span>
                                    </a>
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="">
                                                <?php
                                                                        $appsql1 = $obj->query("select COUNT(a.id) as total,a.branch_id from $tbl_visit as a inner join $tbl_visit_fee as b on a.id=b.visit_id where 1=1 and b.payment_type='Registration' and date(b.cdate) = '$today_date' group by a.branch_id",$debug=-1);
                                                                        ?>
                                            </span></span>
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="">
                                                <?php
                                                                        $appsql1 = $obj->query("select COUNT(a.id) as total,a.branch_id from $tbl_visit as a where 1=1 and a.status='0' and date(a.enrollment_counselor_date) = '$today_date' group by a.branch_id",$debug=-1);
                                                                        ?>
                                            </span></span>
                            ...
                            <div class="row">
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                <?php
                                                                            $appsql1 = $obj->query("select id as num_rows from $tbl_student where 1=1 and profile_accessed_date = '$today_date' and am_id='{$_SESSION['sess_admin_id']}' and profile_accessed=1",$debug=-1);
                            ...
                            <div class="row">
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                <?php
                                                                        $appsql1 = $obj->query("select id as num_rows from $tbl_student_application where 1=1 and  date(cdate) = '$today_date' and parent_id=0 and user_id='{$_SESSION['sess_admin_id']}' and status='Application Submitted'",$debug=-1);
                                                                        $linem1=$obj->numRows($appsql1);
                            ...
                            <div class="row">
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                <?php
                                                                        $appsql1 = $obj->query("select id as num_rows from $tbl_student_application where 1=1 and  date(cdate) = '$today_date' and parent_id=0 and user_id='{$_SESSION['sess_admin_id']}' and status='Offer Received'",$debug=-1);
                                                                        $linem1=$obj->numRows($appsql1);
                            ...
                            <div class="row">
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                <?php
                                                                            $appsql1 = $obj->query("select id as num_rows from $tbl_student_application where 1=1 and  date(cdate) = '$today_date' and parent_id=0 and user_id='{$_SESSION['sess_admin_id']}' and status='I-20 Received'",$debug=-1);
                                                                            $linem1=$obj->numRows($appsql1);
...
<?php
    ...
    <?php
      ...
      foreach($branch_id as $branch){
        echo '<div class="row"> <h5 style="text-align: center;text-decoration: underline; margin-bottom: 10px;">Today’s Performance - '.getField('name',$tbl_branch,$branch).'</h5>';
                ...
                <div class="panel-body pa-0">
                    <div class="sm-data-box">
                        <div class="container-fluid">
                            <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                <a href="javascript:void(0)">
                                    <h6 style="text-align: center;text-decoration: underline; margin-bottom: 10px;"><?=getField('name',$tbl_admin,$res->id)?></h6>
                                </a>
                                <?php
                                    $appsql1 = $obj->query("select id as num_rows from $tbl_student where 1=1 and branch_id = $branch and profile_accessed_date = '$today_date' and am_id='{$res->id}' and profile_accessed=1",$debug=-1);
                                    $linem1=$obj->numRows($appsql1);
                                    
                                ?>
                                <p>Profile Accessed => <?=$linem1;?></p>
                                <?php
                                    $appsql1 = $obj->query("select a.id as num_rows from $tbl_student_application as a inner join $tbl_student as b on a.stu_id = b.id  where 1=1 and b.branch_id = $branch and  date(a.cdate) = '$today_date' and a.parent_id=0 and a.user_id='{$res->id}' and a.status='Application Submitted'",$debug=-1);
                                    $linem1=$obj->numRows($appsql1);
                                    
                                ?>
                                <p>Application Submitted => <?=$linem1;?></p>
                                <?php
                                    $appsql1 = $obj->query("select a.id as num_rows from $tbl_student_application as a inner join $tbl_student as b on a.stu_id = b.id  where 1=1 and b.branch_id = $branch and  date(a.cdate) = '$today_date' and a.parent_id=0 and a.user_id='{$res->id}' and a.status='Offer Received'",$debug=-1);
                                    $linem1=$obj->numRows($appsql1);
                                    
                                ?>
                                <p>Offer Letter Received => <?=$linem1;?></p>
                                <?php
                                    $appsql1 = $obj->query("select a.id as num_rows from $tbl_student_application as a inner join $tbl_student as b on a.stu_id = b.id  where 1=1 and b.branch_id = $branch and  date(a.cdate) = '$today_date' and a.parent_id=0 and a.user_id='{$res->id}' and a.status='I-20 Received'",$debug=-1);
                                    $linem1=$obj->numRows($appsql1);
...
<?php
                ...
                if($_SESSION['level_id'] == 22){
                    $account_manager = getField('account_manager',$tbl_admin,$_SESSION['sess_admin_id']);
                       echo '<div class="row"> <h5 style="text-align: center;text-decoration: underline; margin-bottom: 10px;">Today’s Performance </h5>';
                                   ...
                                   <div class="sm-data-box">
                                       <div class="container-fluid">
                                           <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                               ...
                                               <?php
                                                   $appsql1 = $obj->query("select id as num_rows from $tbl_student where 1=1 and profile_accessed_date = '$today_date' and am_id='{$res->id}' and profile_accessed=1",$debug=-1);
                                                   $linem1=$obj->numRows($appsql1);
                                                   
                                               ?>
                                               <p>Profile Accessed => <?=$linem1;?></p>
                                               <?php
                                                   $appsql1 = $obj->query("select id as num_rows from $tbl_student_application where 1=1 and  date(cdate) = '$today_date' and parent_id=0 and user_id='{$res->id}' and status='Application Submitted'",$debug=-1);
                                                   $linem1=$obj->numRows($appsql1);
                                                   
                                               ?>
                                               <p>Application Submitted => <?=$linem1;?></p>
                                               <?php
                                                   $appsql1 = $obj->query("select id as num_rows from $tbl_student_application where 1=1 and  date(cdate) = '$today_date' and parent_id=0 and user_id='{$res->id}' and status='Offer Received'",$debug=-1);
                                                   $linem1=$obj->numRows($appsql1);
                                                   
                                               ?>
                                               <p>Offer Letter Received => <?=$linem1;?></p>
                                               <?php
                                                   $appsql1 = $obj->query("select id as num_rows from $tbl_student_application where 1=1 and  date(cdate) = '$today_date' and parent_id=0 and user_id='{$res->id}' and status='I-20 Received'",$debug=-1);
                                                   $linem1=$obj->numRows($appsql1);
...
<script>
var chartContainer2 = document.getElementById("Past_Month_Visit_All_Branches");
if (chartContainer2) {
    var charts = new CanvasJS.Chart("Past_Month_Visit_All_Branches", {
        animationEnabled: true,
        exportEnabled: true,
        theme: "light1",
        title: {
            text: "Past Month Visit From Leads - All Branches",
            fontFamily: "Arial",
            fontWeight: "bold",
            fontSize: 14
        },
...
<script>
var chartContainer3 = document.getElementById("Past_Month_Visit_All_Executive");
if (chartContainer3) {
    var charts = new CanvasJS.Chart("Past_Month_Visit_All_Executive", {
        animationEnabled: true,
        exportEnabled: true,
        theme: "light1",
        title: {
            text: "Past Month Visit From Leads - All CRM Executives",
            fontFamily: "Arial",
            fontWeight: "bold",
            fontSize: 14
        },
...
<script>
var chartContainer4 = document.getElementById("past_Month_Leads_TO_Enrollment");
if (chartContainer4) {
    var charts = new CanvasJS.Chart("past_Month_Leads_TO_Enrollment", {
        animationEnabled: true,
        exportEnabled: true,
        theme: "light1",
        title: {
            text: "Past Month Enrollment From Leads - All CRM Executives",
            fontFamily: "Arial",
            fontWeight: "bold",
            fontSize: 14
        },
        ...
        data: [{
            ...
            dataPoints: [
                <?php
                                    ...
                                    $month = date('m');
                                    $year = date('Y');
                                    $get = $obj->query("SELECT branch_id,COUNT(*) as total FROM `$tbl_visit` where enrollment_counselor!=0 and YEAR(enrollment_counselor_date) = $year AND MONTH(enrollment_counselor_date) = $month and visa_sub_type in (3,44,43)  GROUP BY branch_id order by COUNT(*) desc",-1);
                                    while($res = $obj->fetchNextObject($get)){
                                        echo "{ label: '".addslashes(getField('name', $tbl_branch, $res->branch_id))."', y: $res->total },";
                                    }
                                    ?>
        ...
        data: [{
            ...
            dataPoints: [
                <?php
                                        ...
                                        $get = $obj->query("SELECT enrollment_counselor,COUNT(*) as total FROM `$tbl_visit` where branch_id='$branch_id' and enrollment_counselor!=0 and YEAR(enrollment_counselor_date) = $year AND MONTH(enrollment_counselor_date) = $month  and visa_sub_type in (3,44,43) GROUP BY enrollment_counselor order by COUNT(*) desc",-1);
                                        while($res = $obj->fetchNextObject($get)){
...
<?php
            ...
            $getEnrollments = $obj->query("SELECT enrollment_counselor as councellor_id, COUNT(*) as total_enrollments FROM `$tbl_visit` WHERE branch_id='$branch_id' and  enrollment_counselor!=0 and  YEAR(cdate) = $year AND MONTH(cdate) = $month and visa_sub_type in (3,44,43) GROUP BY enrollment_counselor", -1);
...
<?php
            ...
            // Get enrollments data
            $getEnrollments = $obj->query("SELECT enrollment_counselor as councellor_id, COUNT(*) as total_enrollments FROM `$tbl_visit` WHERE enrollment_counselor!=0 and  date(cdate) > '2024-08-01'  and visa_sub_type in (3,44,43) GROUP BY enrollment_counselor", -1);
...
<?php
            ...
            // Get enrollments data
            $getEnrollments = $obj->query("SELECT enrollment_counselor as councellor_id, COUNT(*) as total_enrollments FROM `$tbl_visit` WHERE branch_id='$branch_id' and  enrollment_counselor!=0 and  date(cdate) > '2024-08-01'  and visa_sub_type in (3,44,43)  GROUP BY councellor_id", -1);
            while($resEnrollments = $obj->fetchNextObject($getEnrollments)){
                $counselorData[$resEnrollments->councellor_id]['enrollments'] = $resEnrollments->total_enrollments;
            }
        ...
        data: [{
            ...
            dataPoints: [
                <?php
                                $month = date('m');
                                $year = date('Y');
                                $get = $obj->query("SELECT enrollment_counselor,COUNT(*) as total FROM `$tbl_visit` where enrollment_counselor!=0 and YEAR(enrollment_counselor_date) = $year AND MONTH(enrollment_counselor_date) = $month and visa_sub_type in (3,44,43)  GROUP BY enrollment_counselor order by COUNT(*) desc",-1);
                                while($res = $obj->fetchNextObject($get)){
                                    $reapply_counsellor = addslashes(getField('reapply_counsellor', $tbl_admin, $res->enrollment_counselor));
                                    if($reapply_counsellor == 0 || $reapply_counsellor == null){
                                    echo "{ label: '".addslashes(getField('name', $tbl_admin, $res->enrollment_counselor))."', y: $res->total },";
                                    }
                                }
                                ?>
            ]
...
<script>
var chartContainer17 = document.getElementById("Total_Students_All_Branches");
if (chartContainer17) {
    var chart = new CanvasJS.Chart("Total_Students_All_Branches", {
        exportEnabled: true,
        animationEnabled: true,
        title: {
            text: "Total Students - All Branches",
            fontFamily: "Arial",
            fontWeight: "bold",
            fontSize: 14
        },
        ...
        data: [{
            ...
            dataPoints: [
                <?php
                                    $month = date('m');
                                    $year = date('Y');
                                    $get = $obj->query("SELECT branch_id,COUNT(*) as total FROM `$tbl_student` GROUP BY branch_id",-1);
                                    while($res = $obj->fetchNextObject($get)){
                                ?> {
                    y: <?=$res->total?>,
                    name: "<?=addslashes(getField('name', $tbl_branch, $res->branch_id))?>"
                },
                <?php } ?>
            ]
        }]
    ...
    if (chartContainer) {
        $.ajax({
            ...
            error: function(xhr, status, error) {
                console.error("Error fetching data for chart: " + chartContainerId + " - " + status + ": " + error);
            }
        });
    }
}
...
loadChart("Current_Month_Application_Submitted", "Application Submitted", "Current Month Application Submitted - All Admission Executives");
loadChart("Current_Month_Offer_Letter_Received", "Offer Received", "Current Month Offer Letter Received - All Admission Executives");
...
<?php
                        if($_SESSION['level_id'] == 1){
                            ?>
<div class="row">
    <h5 style="text-align: center;text-decoration: underline; margin-bottom: 10px;">Visits, Enrollments Data</h5>
    <div class="col-md-4">
    ...
    <!-- <div class="col-md-4">
                        <div id="Total_Students_All_Branchess" style="height:300px;margin-bottom: 20px;"></div>
                    </div> -->
    <div class="col-md-8">
...
<?php
                    ...
                    ?>
<div class="row">
    <h5 style="text-align: center;text-decoration: underline; margin-bottom: 10px;"><?=$branch_name?> Data</h5>
    <div class="col-md-4">
        <div id="Current_Month_Visits" style="height:300px;margin-bottom: 20px;"></div>
    </div>
    <div class="col-md-4">
...
<div class="row">
    <h5 style="text-align: center;text-decoration: underline; margin-bottom: 10px;">All Branches Data</h5>
    <div class="col-md-4">
...
<?php } ?>
<?php
                if($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 9 || in_array(4,$addtional_role)){
                    ?>
<div class="row">
    <?php
                        if($_SESSION['level_id'] == 1){                        
                        ?>
    <h5 style="text-align: center;text-decoration: underline; margin-bottom: 10px;">CRM Executive Data</h5>
    <?php } ?>
    <div class="col-md-4">
        <div id="Current_Month_Leads_All_Branches" style="height:300px;margin-bottom: 20px;"></div>
    </div>
    ...
    <div class="col-md-4">
        <div id="Past_Month_Visit_All_Executive" style="height:300px;margin-bottom: 20px;"></div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        <div id="past_Month_Leads_TO_Enrollment" style="height:300px;margin-bottom: 20px;"></div>
    </div>
    <div class="col-md-4">
...
<?php
                ...
                if($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 2 || $_SESSION['level_id'] == 3 || $_SESSION['level_id'] == 19 || $_SESSION['level_id'] == 22){
                ?>
                <div class="col-md-12">
