				...
				<div class="table-responsive">
					<table id="datable_3" class="table table-hover display  pb-30" >
						...
						<tbody>
							<?php
							$i=1;
							$sql=$obj->query("select * from $tbl_gap where 1=1",$debug=-1);
							while($line=$obj->fetchNextObject($sql)){?>
								<tr>
									<td><?php echo $line->id ?></td>
									<td><?php echo getField('name','tbl_qualification',$line->qualification) ?></td>
									...
									echo $gyear." "."Year,"." ".$gMonth." Months";  ?></td>
									<td><?php echo $line->preferred_course ?></td>
									<td><?php echo $line->diploma ?></td>
									<td><?php echo $line->duration ?></td>
									<td><?php echo $line->designation ?></td>
									<td><?php echo $line->exp_duration ?></td>

									<td>  
										<div class="material-switch">
											<input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_gap?>"/>
									...
									<td>
										...
										<a href="gap-del.php?id=<?php echo $line->id ?>" value="Delete" type="submit" class="delete_button" onclick="return confirm('Are you sure you want to delete record(s)')" style=" background: transparent;
