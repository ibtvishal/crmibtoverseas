            ...
            <div class="container-fluid">
                <div class="row heading-bg">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Defer & Refused Admission Load</h5>
                    </div>
                    ...
                    <div class="breadcrumb-section col-lg-4 col-sm-8 col-md-4 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><span><a href="#">Defer & Refused Admission Load</a></span></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                            ...
                                            <table id="datable_3" class="table table-hover display  pb-30">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th width="25%">2 or more i-20 Received</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    if($_SESSION['level_id'] == 2 || $_SESSION['level_id']==25){
                                                        ...
                                                        $query = "SELECT
                                                            (SELECT COUNT(*) FROM $tbl_student WHERE am_id = '{$line->id}' and student_type in (64,20,47,48,50,42)) AS total_students,
                                                            ...
                                                            SUM(CASE WHEN subquery.total_i > 1 THEN 1 ELSE 0 END) AS total_i2
                                                        FROM (
                                                            SELECT stu_id, COUNT(*) as total_i
                                                            FROM $tbl_student_application AS sa
                                                            INNER JOIN $tbl_student AS s ON sa.stu_id = s.id
                                                            WHERE s.am_id = '{$line->id}'  and s.student_type in (64,20,47,48,50,42)
                                                        ...
                                                        WHERE s.am_id = '{$line->id}'
                                                            and student_type in (64,20,47,48,50,42)
                                                               AND s.work_status=1
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a
                                                        target="_blank" href="manage-admission-load-student.php?am_id=<?=base64_encode(base64_encode(base64_encode($line->id)))?>&types=defer&type=all"><?=$total !='' ? $total : 0?></a></td>
                                                        <td><a
                                                                target="_blank" href="manage-admission-load-student.php?am_id=<?=base64_encode(base64_encode(base64_encode($line->id)))?>&types=defer&type=no"><?=$total_i0?></a>
                                                        </td>
                                                        <td>
                                                            <a
                                                                target="_blank" href="manage-admission-load-student.php?am_id=<?=base64_encode(base64_encode(base64_encode($line->id)))?>&types=defer&type=1">
                                                        ...
                                                        <td>
                                                            <a
                                                                target="_blank" href="manage-admission-load-student.php?am_id=<?=base64_encode(base64_encode(base64_encode($line->id)))?>&types=defer&type=2">
                                                                <p>Total Students: <?=$total_i2?></p>
                                                                <p>Load(0): <?=$i202?></p>
                                                            </a>
                                                        </td>
                                                        <td><a
                                                        target="_blank" href="manage-admission-load-student.php?am_id=<?=base64_encode(base64_encode(base64_encode($line->id)))?>&types=defer&type=total"><?=$total_i0 + $total_i1?></a></td>
                                                        <td><a
                                                        target="_blank" href="manage-admission-load-student.php?am_id=<?=base64_encode(base64_encode(base64_encode($line->id)))?>&types=defer&type=total"><?=$total_i0 + $i201 + $i202?></a></td>
                                                    </tr>
                                                    <?php
                                                    } } } else{
