...
$_SESSION['whr1'] = '';
$oct_date = '2024-10-01';
if($_SESSION['level_id'] == 31 || $_SESSION['level_id'] == 34){
...
if($_REQUEST['status']){
    ...
    if($status == 2){
        $whr1 .= " and a.spoken_date_status='0'";
    }elseif($status == 3){
        $whr1 .= " and a.spoken_date_status='1'";
    }
...
<body>
                                                ...
                                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)">
                                                        <span class="txt-dark block counter"><span class="">
                                                                <?php
                                                                    $q1 = "SELECT COUNT(a.id) as num_rows FROM $tbl_visit AS a INNER JOIN $tbl_spoken_classe AS b on b.visit_id = a.id where 1=1 $whr GROUP BY a.id";
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord('Pending')">
                                                        <span class="txt-dark block counter"><span class="">
                                                                <?php
                                                                    // $q1 = "SELECT COUNT(a.id) as num_rows FROM $tbl_visit AS a INNER JOIN $tbl_spoken_classe AS b on b.visit_id = a.id where 1=1 and immigration_trainning_status=0 $whr GROUP BY a.id";
                                                                    echo $obj->numRows($obj->query($q1));
                                                                     ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13"
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord('1')">
                                                        <span class="txt-dark block counter"><span class="">
                                                                <?php
                                                                    // $q1 = "SELECT COUNT(a.id) as num_rows FROM $tbl_visit AS a INNER JOIN $tbl_spoken_classe AS b on b.visit_id = a.id where 1=1 and immigration_trainning_status=1 $whr GROUP BY a.id";
                                                                    echo $obj->numRows($obj->query($q1));
                                                                     ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13"
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord('3')">
                                                        <span class="txt-dark block counter"><span class="">
                                                                <?php
                                                                    $q1 = "SELECT COUNT(a.id) as num_rows FROM $tbl_visit AS a INNER JOIN $tbl_spoken_classe AS b on b.visit_id = a.id where 1=1 and spoken_date_status=1 $whr GROUP BY a.id";
                                                                    echo $obj->numRows($obj->query($q1));
                                                                     ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13"
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="getAppRecord('2')">
                                                        <span class="txt-dark block counter"><span class="">
                                                                <?php
                                                                    $q1 = "SELECT COUNT(a.id) as num_rows FROM $tbl_visit AS a INNER JOIN $tbl_spoken_classe AS b on b.visit_id = a.id where 1=1 and spoken_date_status=0 $whr GROUP BY a.id";
                                                                    echo $obj->numRows($obj->query($q1));
                                                                     ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="btn_submit_class_mode_spoken" class="btn btn-primary">Submit</button>
                    </div>
                </div>
            </div>
        </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="controller.php" method="post" class="">
                        ...
                        <button type="submit" class="btn btn-success" name="btn_update_spoken_branch">Submit</button>
                    </form>
                </div>
            </div>
        </div>
    </div>
       <div class="modal fade bd-example-modal-lg" id="get_spoken_branch_log" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tbody id="get_spoken_branch_log1">
    ...
    var dataTable = $('#studentList').DataTable({
      ...
      if ($_SESSION['level_id']==1  || $_SESSION['level_id'] == 19 || $_SESSION['level_id']==25){?> "aoColumnDefs": [{
        ...
        <?php }?> "ajax": {
            url: "student-spoken-list-ajax.php",
            type: "post",
            error: function() {
    ...
    function get_branch_log(id) {
        $.ajax({
            ...
            url: "controller.php",
            data: {
                get_spoken_branch_log: id
            },
            success: function(data) {
                $("#get_spoken_branch_log1").html(data);
                $("#get_spoken_branch_log").modal('show');
            }
        })
