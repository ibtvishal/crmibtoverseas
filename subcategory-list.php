										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php
													$i=1;
													$sql=$obj->query("select tbl_subcategory.id as id, tbl_subcategory.name as name,  tbl_subcategory.displayorder as displayorder, tbl_subcategory.status as status, tbl_category.name as cat_name  from tbl_subcategory inner join tbl_category on tbl_subcategory.category_id = tbl_category.id  order by tbl_subcategory.id desc");
													...
													<tr>
														...
														<td>  <div class="material-switch">
															<input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo 'tbl_subcategory'?>"/>
														...
														<td>
															...
															<a href="subcategory-del.php?id=<?php echo $line->id ?>" value="Delete" type="submit" class="delete_button" onclick="return confirm('Are you sure you want to delete record(s)')" style=" background: transparent;
...
{	
	...
	$.ajax({
        ...
        data: {id:id,type:'getSubCategory'}, //set data
        beforeSend: function () {
        },
