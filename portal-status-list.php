				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Manage Application Portal</h5>
						</div>
						...
						<div class="breadcrumb-section col-lg-4 col-sm-4 col-md-4 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span><a href="javascript:void();" onclick="ShowModal();">Add Application Portal</a></span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php
													$i=1;
													$sql=$obj->query("select * from $tbl_portal_status where 1=1",$debug=-1);
													...
													<tr>
							                            ...
							                            <input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_portal_status?>"/>
						...
						<div class="modal-dialog" role="document">
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<h5 class="modal-title" id="exampleModalLabel1">Add Portal</h5>
								</div>
...
function ShowModal(){
	$("#exampleModalLabel1").html("Add Application Portal");
	$("#country_id").val("");
	$("#cstatus").val("");
	$("#id").val("");
...
{	
	$("#exampleModalLabel1").html("Update Application Portal");
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,type:'getPortalStatus'}, //set data
        beforeSend: function () {
        },
...
$("#btnSubmit").on("click", function() {	
    ...
    if(id==''){
    	action='addPortalStatus';
    }else{
    	action='updatePortalStatus';    	
    }
	$.ajax({
        type: "POST", 
