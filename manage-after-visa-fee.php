...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">After Visa Fee Student
                ...
                <form method="post" name="searchfrm" id="searchfrm" action="manage-after-visa-fee.php">
                    <div class="row">
                        <div class="col-sm-12">
    ...
    var dataTable = $('#ApplicationList').DataTable({
        ...
        "ajax": {
            url: "manage-after-visa-fee-ajax.php",
            type: "post",
            error: function() {
