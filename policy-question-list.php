...
<body>
                                            ...
                                            <div class="table-responsive">
                                                <table id="datable_3" class="table table-hover display pb-30">
                                                    ...
                                                    <tbody>
                                                        <?php
													$i=1;
													$sql=$obj->query("select * from $tbl_policy_question where 1=1 order by id desc",$debug=-1);
													while($line=$obj->fetchNextObject($sql)){?>
                                                        <tr>
                                                            <td><?php echo $line->id ?></td>
                                                            <td><?php echo getField('name',$tbl_policy_category,$line->cat_id) ?>
                                                            </td>
                                                            <td><?php echo getField('name',$tbl_policy_subcategory,$line->subcat_id) ?>
                                                            </td>
                                                            <td><?php echo $line->question ?></td>
                                                            <td><?php echo strlen($line->answer) > 100 ? substr_replace($line->answer, "...", 100) : $line->answer ; ?>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="material-switch">
                                                                    <input id="someSwitchOptionPrimary<?php echo $i; ?>"
                                                                        ...
                                                                        data-one="<?php echo $tbl_policy_question?>" />
                                                                    <label
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="controller.php?question_delete_id=<?php echo $line->id ?>"
                        ...
                        <div class="modal-content" style="width: 800px;">
                            <form method="post" action="controller.php">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select name="cat_id" id="cat_id" class="form-control"
                                            onchange="get_subcat('tbl_policy_subcategory',this.value)">
                                            <option value="">Select Category</option>
                                            <?php
												$i=1;
												$csql=$obj->query("select * from $tbl_policy_category where 1=1",$debug=-1);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="subcat_id" id="subcat_id" class="form-control">
                                            ...
                                            <?php
												$i=1;
												$csql=$obj->query("select * from $tbl_policy_subcategory where 1=1",$debug=-1);
												while($cline=$obj->fetchNextObject($csql)){?>
                                            <option value="<?php echo $cline->id ?>"><?php echo $cline->name ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="btnSubmit1" name="btnSubmit1" class="btn btn-primary">Submit</button>
                                </div>
                            </form>
                        </div>
    ...
    $("#btnSubmit").on("click", function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                // Use strict comparison and debug response if needed
                if (response.trim() === "1") {
    ...
    function chagnedisplayOrder(id, ival) {
        $.ajax({
            ...
            data: {
                id: id,
                ival: ival,
                type: 'changequestionDisplayOrder1'
            }, //set data
            beforeSend: function() {},
            success: function(response) {
