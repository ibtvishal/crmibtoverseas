...
if($_REQUEST['status']){
    ...
    if($status == 2){
        $whr1 .= " and b.dtype  = 3   and b.with_financial_verify=1";
    }
    if($status == 3){
        $whr1 .= " and b.dtype = 3   and b.with_financial_verify=0";
    }
    if($status == 4){
        $whr1 .= " and b.dtype = 3  and b.with_financial_verify=2";
    }
    if($status == 5){
        $whr1 .= "  and b.dtype = 3  and b.financial_verify=1";
    }
    if($status == 6){
        $whr1 .= " and b.dtype = 3   and b.financial_verify=0";
    }
    if($status == 7){
        $whr1 .= "  and b.dtype = 3  and b.financial_verify=2";
    }
  }
  $_SESSION['whr'] = $whr; 
  $_SESSION['whr1'] = $whr1;  
...
<body>
                ...
                <div class="row heading-bg">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        if(isset($_GET['pending'])){
                            echo '<h5 class="txt-dark">Financial By Pass</h5>';
                        }else{
                        ?>
                        <h5 class="txt-dark">Statement Verification</h5>
                        <?php } ?>
                    </div>
                                            ...
                                            <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                <a href="javascript:void(0)" onclick="getAppRecord(1)">
                                                    <span class="txt-dark block counter"><span class="counter-anim">
                                                            <?php
                                                                $sql=$obj->query("select a.id as num_rows from $tbl_student as a inner join $tbl_student_document as b on a.id = b.stu_id  where 1=1 and b.dtype in (3) $whr group by a.id",$debug=-1);
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                <a href="javascript:void(0)" onclick="getAppRecord(5)">
                                                    <span class="txt-dark block counter"><span class="counter-anim">
                                                            <?php
                                                                $sql=$obj->query("select a.id as num_rows from $tbl_student as a inner join $tbl_student_document as b on a.id = b.stu_id  where 1=1 and b.dtype in (3) and b.financial_verify=1 $whr group by a.id",$debug=-1);
                                                                $lines=$obj->numRows($sql);
                                                                    echo $lines;
                                                                     ?>
                                                        </span></span>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                <a href="javascript:void(0)" onclick="getAppRecord(6)">
                                                    <span class="txt-dark block counter"><span class="counter-anim">
                                                            <?php
                                                                $sql=$obj->query("select a.id as num_rows from $tbl_student as a inner join $tbl_student_document as b on a.id = b.stu_id  where 1=1 and b.dtype in (3) and b.financial_verify=0 $whr group by a.id",$debug=-1);
                                                                $lines=$obj->numRows($sql);
                                                                    echo $lines;
                                                                     ?>
                                                        </span></span>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                <a href="javascript:void(0)" onclick="getAppRecord(7)">
                                                    <span class="txt-dark block counter"><span class="counter-anim">
                                                            <?php
                                                                $sql=$obj->query("select a.id as num_rows from $tbl_student as a inner join $tbl_student_document as b on a.id = b.stu_id  where 1=1 and b.dtype in (3) and b.financial_verify=2 $whr group by a.id",$debug=-1);
                                                                $lines=$obj->numRows($sql);
                                                                    echo $lines;
                                                                     ?>
                                                        </span></span>
                                                    <span class="weight-500 uppercase-font block font-13">
                                                        Disapproved With Financial</span>
                                                </a>
                                            </div>
                                            <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                <i class="icon-user-following data-right-rep-icon txt-light-grey"></i>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1) {
                            ...
                            $("#change_hide_status1" + id).attr('cl-ass', 'btn btn-success');
                        }
                    }
                })
            } else if (result.isDenied) {
    ...
    var dataTable = $('#datable_3s').DataTable({
        ...
        "ajax": {
            url: "ajax-table/financial-approval-ajax.php",
            type: "post",
            error: function() {
