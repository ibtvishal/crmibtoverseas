                ...
                <div class="student_filter">
                    ...
                    <form method="post" action="" name="studentfrm" id="studentfrm" enctype= multipart/form-data meaning>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="view-details" style="display:none;" >
                                <div class="form-group">
                                    <div class="input-group">
                        ...
                        <div class="row" id="view-details" style="margin-top:10px; display:none;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group">
                        ...
                        <div class="row form-group" id="view-details" style="padding:0 15px; display:none;">
                            <div><h6 style="background:#4b4b4d;padding:5px; color:white;  border-radius:5px;">Recent Qualifiaction</h6></div>
                        </div>
                        <div class="row" id="view-details" style="display:none;">
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row form-group" id="view-details" style="padding:0 15px; display:none;">
                            <div><h6 style="background:#4b4b4d;padding:5px; color:white;  border-radius:5px;">Source</h6></div>
                        </div>
                        <div class="row" id="view-details" style="display:none;">
                            <div class="col-md-2">
                                <div class="input-group">
