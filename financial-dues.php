...
$whr = "";
$_SESSION['whr'] = '';
if($_SESSION['level_id'] == 14 || $_SESSION['level_id'] == 19){
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Financial Dues</h5>
                    </div>
                                            ...
                                            <table id="studentList" class="table table-hover display  pb-30">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Branch Name</th>
                                                        <th>Financial Dues By Passed By</th>
                                                        <th>Action</th>
                                                    </tr>
                                                </thead>
    ...
    var dataTable = $('#studentList').DataTable({
        ...
        "ajax": {
            url: "ajax-table/financial-dues-ajax.php",
            type: "post",
            error: function() {
