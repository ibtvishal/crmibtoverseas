...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <h5 class="txt-dark">Manage Video</h5>
                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table id="datable_1" class="table table-hover display  pb-30">
                                                    ...
                                                    <tbody>
                                                        <?php
													$i=1;
													$sql=$obj->query("select * from $tbl_videos where 1=1",$debug=-1);
													while($line=$obj->fetchNextObject($sql)){?>
                                                        <tr>
                                                            <td><?php echo $line->id ?></td>
                                                            <td><img src="uploads/<?php echo $line->img ?>"
                                                                    style="height:50px"></td>
                                                            <td><?php echo $line->video ?></td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="video-del.php?id=<?php echo $line->id ?>"
                            ...
                            <form method="post" id="addstate" name="addstate">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label mb-10">Thumbnail:</label>
                                        <input type="hidden" name="old_image" id="old_image" value="">
                                        <input type="file" class="form-control" id="img" name="img">
                                        <span id="imagePreview"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label mb-10">Video:</label>
                                        <input type="text" class="form-control" id="video" name="video">
                                    </div>

                                    <span id="err_video" style="color:red;"></span>
                                </div>
    ...
    <script>
    function ShowModal() {
        $("#exampleModalLabel1").html("Add Video");
        $("#video").val("");
        $("#id").val("");
    ...
    function getModalData(id) {
        $("#exampleModalLabel1").html("Update Video");
        $.ajax({
            type: "GET",
            ...
            success: function(response) {
                ...
                $("#id").val(response[0]);
                $("#video").val(response[1]);
                $("#old_image").val(response[2]);
                $("#imagePreview").html(
                    `<img src="uploads/${response[2]}" alt="Image" class="img-fluid" style="width: 100px; height: 100px;"/>`
                );
                $("#exampleModal").modal('show');
            }
        });
    ...
    $("#btnSubmit").on("click", function() {
        ...
        var id = $("#id").val();
        var action = (id === '') ? 'addvideo' : 'updatevideo';
