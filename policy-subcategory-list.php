										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php
													$i=1;
													$sql=$obj->query("select $tbl_policy_subcategory.id as id, $tbl_policy_subcategory.name as name,  $tbl_policy_subcategory.displayorder as displayorder, $tbl_policy_subcategory.status as status, $tbl_policy_category.name as cat_name  from $tbl_policy_subcategory inner join $tbl_policy_category on $tbl_policy_subcategory.category_id = $tbl_policy_category.id  order by $tbl_policy_subcategory.id desc");
													...
													<tr>
														...
														<td>  <div class="material-switch">
															<input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_policy_subcategory?>"/>
														...
														<td>
															...
															<a href="controller.php?subcat_delete_id=<?php echo $line->id ?>" value="Delete" type="submit" class="delete_button" onclick="return confirm('Are you sure you want to delete record(s)')" style=" background: transparent;
							...
							<div class="modal-content">
								...
								<div class="modal-body">									
										<div class="form-group">
                                            ...
                                            <?php
													$sql=$obj->query("select * from $tbl_policy_category where 1=1",$debug=-1);
													while($line=$obj->fetchNextObject($sql)){?>
...
{	
	...
	$.ajax({
        ...
        data: {id:id,type:'getSubCategory1'}, //set data
        beforeSend: function () {
        },
...
$("#btnSubmit").on("click", function() {
    ...
    if(id==''){
    	action='addSubCategory1';
    }else{
    	action='updateSubCategory1';    	
    }
	$.ajax({
        type: "POST", 
...
{	
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,ival:ival,type:'changesubDisplayOrder1'}, //set data
        beforeSend: function () {
        },
        success: function (response) {
