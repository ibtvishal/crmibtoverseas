            ...
            <div class="container-fluid">
                <div class="row heading-bg">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">FAQ USA Wikipedia</h5>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3" style="padding:0;">
                        <div class="sidebar" style="height: 400px;overflow: auto;">
                            <ul class="nav flex-column">
                                ...
                                $catSql = $obj->query("select * from $tbl_category where status=1 $whr order by displayorder asc");
                                while($res = $obj->fetchNextObject($catSql)){
                                    $countSql = $obj->query("select count(*) as total_rows from tbl_subcategory where category_id='".$res->id."' and status=1");
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="collapse list-unstyled " aria-labelledby="navbarDropdown<?=$res->id?>"
                                        ...
                                        <?php
                                        $gets = $obj->query("select * from tbl_subcategory where category_id='".$res->id."' and status=1 order by displayorder asc");
                    ...
                    <div class="col-md-8 wikipedia-list">
