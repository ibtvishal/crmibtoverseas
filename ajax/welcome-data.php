                ...
                <div class="panel-body pa-0">
                    <div class="sm-data-box">
                        <div class="container-fluid">
                            <div class="bg-gray-300 p-4 rounded-[12px]">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        <a href="javascript:void(0)">
                                            ...
                                            <span class="weight-500 uppercase-font block font-20"
                            ...
                            <div class="row">
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="weight-500 uppercase-font block font-20">Leads</span>
                                    </a>
                                    <?php
...
<?php
            ...
            $getEnrollments = $obj->query("SELECT b.branch_id as branch_id, COUNT(b.id) as total_enrollments FROM `$tbl_visit` as a inner join $tbl_student as b on (a.applicant_contact_no=b.student_contact_no or a.applicant_alternate_no=b.alternate_contact or a.applicant_contact_no=b.alternate_contact or a.applicant_alternate_no=b.student_contact_no ) $tbl_visa_sub_type_join WHERE b.branch_id!=0 and  date(b.cdate) > '2024-08-01'  $condition_of_visa_sub_type GROUP BY b.branch_id", -1);
...
<?php
            ...
            // Get enrollments data
            $getEnrollments = $obj->query("SELECT b.c_id as councellor_id, COUNT(b.id) as total_enrollments FROM `$tbl_visit` as a inner join $tbl_student as b on (a.applicant_contact_no=b.student_contact_no or a.applicant_alternate_no=b.alternate_contact or a.applicant_contact_no=b.alternate_contact or a.applicant_alternate_no=b.student_contact_no ) $tbl_visa_sub_type_join WHERE a.enrollment_counselor!=0 and  date(a.cdate) > '2024-08-01' and a.visit_status='Enrolled' and b.transfer=0 $condition_of_visa_sub_type GROUP BY a.enrollment_counselor", -1);
            while($resEnrollments = $obj->fetchNextObject($getEnrollments)){
        ...
        data: [{
            ...
            dataPoints: [
                <?php
                                    ...
                                    $year = date('Y');
                                    $branch_id = getField('branch_id',$tbl_admin, $_SESSION['sess_admin_id']);
                                    $get = $obj->query("SELECT councellor_id,COUNT(*) as total FROM `$tbl_visit` where branch_id in ($branch_id) and  councellor_id!=0 and  YEAR(cdate) = $year AND MONTH(cdate) = $month GROUP BY councellor_id",-1);
                                    while($res = $obj->fetchNextObject($get)){
                                ?> {
                    y: <?=$res->total?>,
...
<div class="row">
    ...
    <?php if ($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25 || $_SESSION['level_id']==19 || $_SESSION['level_id'] == 2 ) {?>
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="panel panel-default card-view pa-0">
            <div class="panel-wrapper collapse in">
                <div class="panel-body pa-0">
                    <div class="sm-data-box">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a <?php if ($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25){ ?>
    ...
    <?php } 
                    if ($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25 || $_SESSION['level_id']==19 || $_SESSION['level_id'] == 2  ) {
                ?>
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="panel panel-default card-view pa-0">
            <div class="panel-wrapper collapse in">
    ...
    <?php if ($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25 || $_SESSION['level_id']==19 || $_SESSION['level_id'] == 2   || $_SESSION['level_id']==4 || $_SESSION['level_id']==5 || $_SESSION['level_id']==6 || $_SESSION['level_id']==7 || $_SESSION['level_id']==8) {
                ?>
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="panel panel-default card-view pa-0">
            <div class="panel-wrapper collapse in">
                                ...
                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                    <a
                                        ...
                                        <span class="txt-dark block counter"><span class="counter-anim"><?php
                                            ...
                                            }else if ($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25){
...
<?php
                $whr = '';
                $addtional_role = explode(',',$_SESSION['additional_role']);
                if($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25 || $_SESSION['level_id']==19 || $_SESSION['level_id'] == 2  || $_SESSION['level_id']==3 || $_SESSION['level_id']==4 || in_array(2,$addtional_role)){
...
<?php
                if($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25 || $_SESSION['level_id']==19 || $_SESSION['level_id']==10  || $_SESSION['level_id']==19){
                $condition = '';
                if($_SESSION['level_id']==10 || $_SESSION['level_id']==19){
                    $branch_id = getField('branch_id',$tbl_admin,$_SESSION['sess_admin_id']);
                    $condition = " and a.branch_id in ($branch_id)";
                        ...
                        <div class="sm-data-box">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        <a href="javascript:void(0)"
                                            <?php if($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25 || $_SESSION['level_id']==19 || $_SESSION['level_id']==10  || $_SESSION['level_id']==19){ ?>
                        ...
                        <div class="sm-data-box">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        <a href="javascript:void(0)"
                                            <?php if($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25 || $_SESSION['level_id']==10  || $_SESSION['level_id']==19){ ?>
...
<?php }?>
<?php
                if($_SESSION['level_id'] == 1 || $_SESSION['level_id'] == 25 || $_SESSION['level_id'] == 2  || $_SESSION['level_id']==3 || $_SESSION['level_id']==4  || in_array(2,$addtional_role)){
                $whra = '';
