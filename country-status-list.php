				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Manage Application Status</h5>
						</div>
						...
						<div class="breadcrumb-section col-lg-4 col-sm-4 col-md-4 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span><a href="javascript:void();" onclick="ShowModal();">Add Application Status</a></span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php
													$i=1;
													$sql=$obj->query("select * from $tbl_country_status where 1=1",$debug=-1);
													...
													<tr>
							                            ...
							                            <input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_country_status?>"/>
														...
														<!-- 	<a href="stage-del.php?id=<?php echo $line->id ?>" value="Delete" type="submit" class="delete_button" onclick="return confirm('Are you sure you want to delete record(s)')" style=" background: transparent;
...
function ShowModal(){
	$("#exampleModalLabel1").html("Add Application Status");
	$("#country_id").val("");
	$("#cstatus").val("");
	$("#id").val("");
...
{	
	$("#exampleModalLabel1").html("Update Application Status");
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,type:'getCountryStatus'}, //set data
        beforeSend: function () {
        },
...
$("#btnSubmit").on("click", function() {	
    ...
    if(id==''){
    	action='addCountryStatus';
    }else{
    	action='updateCountryStatus';    	
    }
	$.ajax({
        type: "POST", 
        url: 'ajax/submitData.php', 
        data: {'id':id,'country_id':country_id,'cstatus':cstatus,'action':action}, 
        success: function (response) {
