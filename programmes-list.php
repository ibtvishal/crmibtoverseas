...
if($_REQUEST['course_type']){
	...
	$whr .=" and course_type='$course_type'";
}
$_SESSION['whr'] = $whr;
?>
<!DOCTYPE html>
...
<body>
            ...
            <div class="container-fluid">
                <div class="row heading-bg prgrm_bg">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Manage Courses</h5>
                    </div>

                    <form class="form-horizontal form_csv_download"
                        action="download_excel.php?table_name=tbl_programmes&amp;p=programmes-list" method="post"
                        name="upload_excel" enctype="multipart/form-data" style="">
                        <div class="row">

                            <div class="col-md-4 col-6">
                                <input type="submit" name="programmesList" class="btn btn-primary download_csv_button"
                ...
                <div class="row">
                    <div class="col-sm-12" style="margin-left:115px;">
						...
						while($line=$obj->fetchNextObject($sql)){?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group" style="margin-left:12px;">
                                            <select name="filter_university" id="filter_university" class="form-control"
                                                required="">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type='submit' name='productImport' value='Upload'
                                                class="btn upload_csv_button btn-primary" style="">
                                        </div>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <div class="table-wrap">
                                            <div class="table-responsive">
                                                <form action="" method="post" id="submit_form">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <select name="course_type" id="course_types"
                                                                class="form-control" onchange="submit_form()">
                                                                <option value="">Select Course Type</option>
                                                                <option value="STEM">STEM</option>
                                                                <option value="NON STEM">NON STEM</option>
                                                            </select>
                                                        </div>
                                                        <button type="submit" style="display:none">syvnut</button>
                                                    </div>
                                                </form>
                                                <table id="ProgrammeList" class="table table-hover display  pb-30">
                                                    <div class="choose_prog" style="">
                                                        <h5
                                                            style="color:#2a911d; padding-left: 300px; font-size: 16px; font-weight: bold;">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Duolingo</th>
                                                            <th>TOEFL</th>
                                                            <th>MOI/ /Fees Before Interview</th>
                                                            <th>i20 Fee / English Waiver</th>
                                                            <th>Scholarship</th>
                                                            <th>Scholarship Percentage / Rough annual fees (GBP)</th>
                                                            <th>Special Requirement / CAS Deposit</th>
                                                            <th>Course Type / Rough fee after Scholarsship</th>
                                                            <th>Status</th>
                                                            <th>Action</th>
                                                        </tr>
                                                    </thead>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title" id="exampleModalLabel1">Add Courses</h5>
                            </div>
                            <div class="modal-body">
                                <form method="post" id="addProgrammes" name="addProgrammes">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="recipient-name"
                                                    class="control-label mb-10">University:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10">Program
                                                    Level:</label>
                                                <input type="text" class="form-control" name="program_level"
                                                    id="program_level" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10">Course
                                                    Name:</label>
                                                <select name="course_name" id="course_name" class="form-control"
                                                    required>
                                                    <option value="">Select Course</option>
                                                </select>
                                                <input type="text" class="form-control" name="add_course_name_field"
                                                    id="add_course_name_field" value="" style="display:none;" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10">Tuition
                                                    Fee:</label>
                                                <input type="text" class="form-control" name="tuition_fee"
                                                    id="tuition_fee" required max="2" min="0"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10">Student
                                                    Bachelors:</label>
                                                <input type="text" class="form-control" name="student_bachelors"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="recipient-name"
                                                    class="control-label mb-10">Percentage:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ielts" id="ielts"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="pte" id="pte"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="recipient-name"
                                                    class="control-label mb-10">DUOLINGO:</label>
                                                <input type="text" class="form-control" name="duolingo" id="duolingo"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="tofel" id="tofel"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10"
                                                    id="moi_label">MOI:</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10"
                                                    id="scholarship_label">Scholarship:</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10"
                                                    id="scholarship_percentage_label">Scholarship Percentage:</label>
                                                <input type="text" class="form-control" name="scholarship_percentage"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10"
                                                    id="special_requirement_label">Special Requirements:</label>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="recipient-name" class="control-label mb-10"
                                                    id="course_type_label">Course Type:</label>
                                                <select type="text" class="form-control" name="course_type"
                                                    id="course_type">
                                                    <option value="">Select Course Type</option>
                                                    <option value="STEM">STEM</option>
                                                    <option value="NON STEM">NON STEM</option>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#ProgrammeList').DataTable({
            "processing": true,
            "serverSide": true,
            "stateSave": false,
            "lengthMenu": [
        ...
        $('#country').change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    //response = response.split('##');
                    if (country_id == 6) {
                        $("#moi_label").html('Fees Before Interview:');
                        $("#fees_label").html('English Waiver:');
                        $("#scholarship_percentage_label").html('Rough annual fees (GBP):');
                        $("#special_requirement_label").html('CAS Deposit:');
                        $("#course_type_label").html('Rough fee after Scholarsship:');
                    } else {
                        $("#moi_label").html('MOI:');
                        $("#fees_label").html('i20 Fee:');
                        $("#scholarship_percentage_label").html('Scholarship Percentage:');
                        $("#special_requirement_label").html('Special Requirements:');
                        $("#course_type_label").html('Course Type:');
                    }
        ...
        $("#course_name").change(function() {
            cval = $(this).val();
            if (cval == 'other') {
                $("#add_course_name_field").css("display", "block");
            } else {
                $("#add_course_name_field").css("display", "none");
            }
        })
    ...
    function ShowModal() {
        $("#exampleModalLabel1").html("Add Courses");
    ...
    function getModalData(id) {
        $("#exampleModalLabel1").html("Update Courses");
        $.ajax({
            type: "GET",
            url: 'ajax/getModalData.php',
            data: {
                id: id,
                type: 'updateProgrammes'
            },
            beforeSend: function() {},
            success: function(response) {
                ...
                $("#scholarship").val(response[18]);
                $("#scholarship_percentage").val(response[19]);
                $("#special_requirement").val(response[20]);
                $("#course_type").val(response[21]);
    ...
    $("#btnSubmit").on("click", function() {
        ...
        if (course_name == 'other') {
            add_course_name_field = $("#add_course_name_field").val();
        } else {
        ...
        scholarship_percentage = $("#scholarship_percentage").val();
        ...
        if (course_name == '') {
            ...
            return;
        } else if (course_name == 'other' && add_course_name_field == '') {
            $("#err_course_name").show().html("This field is required.");
            return;
        }
        if (intake == '') {
        ...
        $.ajax({
            ...
            data: {
                ...
                'add_course_name_field': add_course_name_field,
                'intake': intake,
                'program_duration': program_duration,
                'tuition_fee': tuition_fee,
                'student_bachelors': student_bachelors,
    ...
    $("#add_course_name_field").change(function() {
        $("#err_course_name").hide();
    })
