                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="required form-control" placeholder="ENQUIRY TYPE" name="stu_name" id="stu_name" value="<?php echo stripslashes($result->stu_name); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
