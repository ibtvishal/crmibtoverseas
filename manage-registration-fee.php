...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Registration Students
                ...
                <form method="post" name="searchfrm" id="searchfrm" action="manage-registration-fee.php">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="panel panel-default card-view">
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                                <div class="col-md-4">Color Code: <span style="color:red">Enrollment Payment Not Paid</span></div>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <form action="add-fee.php" method="get">
                    <div class="modal-body" style="text-align: center;">
                        ...
                        <input type="hidden" class="form-control" id="get_type" name="type" value="Enrollment" required>
                        <center>
                            <div class="row">
    ...
    var dataTable = $('#ApplicationList').DataTable({
        ...
        "ajax": {
            url: "manage-registration-fee-ajax.php",
            type: "post",
            error: function() {
    ...
    <script>
        function get_modal_data(id){
            $.ajax({
                method:"POST",
                url:"controller.php",
                data:{id:id,type:'Registration',get_modal_data_fee:1},
