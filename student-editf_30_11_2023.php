            ...
            <li class="active" role="presentation"><a aria-expanded="true" data-toggle="tab"
              ...
              <li role="presentation" class=""><a data-toggle="tab" id="profile_tab_7"
                ...
                <li class="" role="presentation"><a aria-expanded="true" data-toggle="tab"
                  role="tab" id="status_tab_7" href="#status_7">Profile Status</a></li>
                                  ...
                                  while($line=$obj->fetchNextObject($sql)){?>
                                    <tr>
                                      <td><?php echo $line->id; ?></td>
                                       <td><?php echo date('d-M-Y',strtotime($line->cdate)); ?><br><?php echo date('h:i a',strtotime($line->cdate)); ?></td>
                        ...
                        <form method="post"  id="addnotes" name="addnotes">
                          ...
                          <div class="form-group">
                            <select class="form-control notes_stage_id" name="notes_stage_id" id="notes_stage_id" required="">
                              ...
                              <?php
                              $sql=$obj->query("select * from $tbl_student_application where 1=1 and stu_id='".base64_decode(base64_decode(base64_decode($_REQUEST['id'])))."'",-1);
                              while($resultt=$obj->fetchNextObject($sql)){?>
                          ...
                          <div class="form-group">
                            <textarea class="form-control" rows="3" placeholder="Remarks" id="notes_remarks" name="notes_remarks" readonly></textarea>
  ...
  function showCommentBox(id){
          ...
          $("#btnSubmitApplication").on("click", function() {    
            ...
            $.ajax({
              type: "POST", 
              url: 'ajax/submitData.php', 
              data: {'id':id,'student_id':student_id,'state_id_application':state_id_application,'univercity_id_application':univercity_id_application,'course':course,'app_status':app_status,'month':month,'year':year,'portal_status':portal_status,'remarks':remarks,'action':action}, 
              success: function (response) {
                //console.log(response);
                if(response==1){
