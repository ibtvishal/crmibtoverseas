...
if($_REQUEST['status']){
    ...
    elseif($status == 'Traveled without Paying our Fee'){
        $whr1 .= " and c.defer_next_intake=2";
    }
    elseif($status == 'Defer Next Intake'){
        $whr1 .= " and c.defer_next_intake=1";
    }
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark"><?=isset($_GET['passport']) ? 'Passport Status' : 'Visa Approved Details'?>
                        </h5>
                    </div>
                    ...
                    <div class="breadcrumb-section col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <span><a><?=isset($_GET['passport']) ? 'Passport Status' : 'Visa Approved Details'?></a></span>
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="col-md-3" style="display:none">
                            <div class="form-group">
                                <select class="form-control form-select" name="status" id="status"
                                    ...
                                    <option value="Defer Next Intake"
                                        <?php if($_REQUEST['status']=='Defer Next Intake'){?>selected <?php } ?>>Defer
                                        Next Intake</option>
                                    <option value="Traveled without Paying our Fee"
                                        <?php if($_REQUEST['status']=='Traveled without Paying our Fee'){?>selected
                                        <?php } ?>>Traveled without Paying our Fee</option>
                                    <option value="All Pending" <?php if($_REQUEST['status']=='All Pending'){?>selected
                                        <?php } ?>>All Pending</option>
                                    <option value="Half Done" <?php if($_REQUEST['status']=='Half Done'){?>selected
                                        <?php } ?>>Half Done</option>
                                    <option value="Full Done" <?php if($_REQUEST['status']=='Full Done'){?>selected
                                        <?php } ?>>Full Done</option>
                                    <option value="AfterVisa Fee Pending"
                                        <?php if($_REQUEST['status']=='AfterVisa Fee Pending'){?>selected <?php } ?>>
                                        AfterVisa Fee Pending</option>
                                    <option value="AfterVisa Fee Paid"
                                        <?php if($_REQUEST['status']=='AfterVisa Fee Paid'){?>selected <?php } ?>>
                                        AfterVisa Fee Paid</option>
                                    <option value="Pending Payment Status"
                                        <?=$_REQUEST['status']  == 'Pending Payment Status' ? 'selected' : '' ?>>Pending
                                        Payment Status</option>
                                    <option value="Paying Fee Payment Status"
                                        <?=$_REQUEST['status']  == 'Paying Fee Payment Status' ? 'selected' : '' ?>>
                                        Paying Fee Payment Status</option>
                                    <option value="Settlement Payment Status"
                                        <?=$_REQUEST['status']  == 'Settlement Payment Status' ? 'selected' : '' ?>>
                                        Settlement Payment Status</option>
                                    <?php
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        <span class="weight-500 uppercase-font block font-13">University fee Pending</span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <i
                                    ...
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)"
                                                        onclick="submit_data1('Handover to Student')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='Handover to Student'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Handover
                                                            to Student </span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                    ...
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)"
                                                        onclick="submit_data1('Received by Student')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='Received by Student'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Received
                                                            by Student </span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                    ...
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)"
                                                        onclick="submit_data1('Received by Branch')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='Received by Branch'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                    ...
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)"
                                                        onclick="submit_data1('Received by IBT')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='Received by IBT'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                ...
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="submit_data1('At Embassy')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='At Embassy'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">At Embassy
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                    ...
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)"
                                                        onclick="submit_data1('Ready for Pick-up')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='Ready for Pick-up'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Ready for
                                                            Pick-up </span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                ...
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="submit_data1('Transmit')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='Transmit'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Transmit
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                    ...
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)"
                                                        onclick="submit_data1('Origination Scan')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='Origination Scan'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span
                                                            class="weight-500 uppercase-font block font-13">Origination
                                                            Scan </span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                ...
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <a href="javascript:void(0)" onclick="submit_data1('Created')">
                                                        <span class="txt-dark block counter"><span class="counter-anim">
                                                                <?php
                                                                $sql = $obj->query("SELECT a.id FROM $tbl_student AS a INNER JOIN $tbl_student_status AS b on b.stu_id = a.id LEFT JOIN $tbl_student_enrollment as c on c.stu_id = a.id WHERE b.cstatus = 'Visa Approved' and c.passport_status='Created'  $whr GROUP BY a.id",$debug=-1);
                                                                $line=$obj->numRows($sql);
                                                                echo $line;
                                                                ?>
                                                            </span></span>
                                                        <span class="weight-500 uppercase-font block font-13">Created
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                    ...
                                    <div class="table-wrap">
                                        ...
                                        <div class="table-responsive">
                                            <table id="studentList"
                                                class="table table-hover display  pb-30 table-bordered">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>After Visa Fee</th>
                                                        <!-- <th>Enrollment Status</th> -->
                                                        <th>Mail id</th>
                                                        <th>Mail Password</th>
                                                        <th>University Portal login</th>
                                                        <th>University Portal Password</th>
                                                        <th>Advisor Meeting</th>
                                                        ...
                                                        <th>Sattlement Amount Status</th>
                                                        <th>Fee Paid Through</th>
                                                        <th>Payment method</th>
                                                        <th>TT Reciept No</th>
                                                        <th>Enrollment Remark</th>
                                                        <!-- <th>Refund Reason</th>
                                                        <th>Refund Applied Date</th>
                                                        <th>Refund Commission commmitted</th>
                                                        <th>Refund Status</th>
    ...
    var dataTable = $('#studentList').DataTable({
      ...
      if ($_SESSION['level_id']==1){?> "aoColumnDefs": [{
        ...
        <?php }?> "ajax": {
            url: "student-visa-approved-enrollment-ajax.php",
            type: "post",
            error: function() {
