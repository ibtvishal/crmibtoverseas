				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						  <h5 class="txt-dark">Manage Slot Agent</h5>
						</div>
						...
						<div class="breadcrumb-section col-lg-4 col-sm-8 col-md-8 col-xs-12">
						  <ol class=" breadcrumb">
							...
							<li class="active"><span><a href="javascript:void();" onclick="ShowModal();">Add Slot Agent</a></span></li>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php
													$i=1;
													$sql=$obj->query("select * from $tbl_slot_agent where 1=1",$debug=-1);
													while($line=$obj->fetchNextObject($sql)){?>
													<tr>
														<td><?php echo $i ?></td>
														<td><?php echo $line->name ?></td>
														<td>  <div class="material-switch">
															<input id="someSwitchOptionPrimary<?php echo $i; ?>"  type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_slot_agent?>"/>
														...
														<td>
															...
															<a href="controller.php?slot_agent_del_id=<?php echo $line->id ?>" value="Delete" type="submit" class="delete_button" onclick="return confirm('Are you sure you want to delete record(s)')" style=" background: transparent;
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<div class="modal-header">
									...
									<h5 class="modal-title" id="exampleModalLabel1">Add Slot Agent</h5>
								</div>
								<div class="modal-body">									
										<div class="form-group">
											<label for="recipient-name" class="control-label mb-10">Slot Agent Name:</label>
...
function ShowModal(){
	$("#exampleModalLabel1").html("Add Slot Agent");
	$("#cname").val("");
	$("#id").val("");
...
{	
	$("#exampleModalLabel1").html("Update Slot Agent");
	$.ajax({
        type: "GET", 
        url: 'ajax/getModalData.php',
        data: {id:id,type:'getslotagent'}, //set data
        beforeSend: function () {
        },
