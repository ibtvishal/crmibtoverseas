...
$sql=$obj->query("select COUNT(a.id) as num_rows from $tbl_lead as a inner JOIN $tbl_student as c on (a.applicant_contact_no=c.student_contact_no or a.applicant_alternate_no=c.student_contact_no or a.applicant_contact_no=c.alternate_contact or a.applicant_alternate_no=c.alternate_contact) where 1=1 $whr",$debug=-1);
...
$sql="select a.* from $tbl_lead as a inner JOIN $tbl_student as c on (a.applicant_contact_no=c.student_contact_no or a.applicant_alternate_no=c.student_contact_no or a.applicant_contact_no=c.alternate_contact or a.applicant_alternate_no=c.alternate_contact) where 1=1 $whr";
