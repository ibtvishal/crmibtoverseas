                        ...
                        <form name="frm" method="post" action="country-del.php" enctype="multipart/form-data">
                          ...
                          <tbody>
                            ...
                            while($line=$obj->fetchNextObject($sql)){
                              ...
                              if($line->counsellor_status==0 && $line->company_id==0 && $line->pimg==''){
                                $disabled1 = '';
                                $disabled2 = 'disabled';
                                $disabled3 = 'disabled';
                              }else if($line->counsellor_status==0 && $line->company_id!=0 && $line->pimg==''){
                                $disabled1 = 'disabled';
                                $disabled2 = '';
                                $disabled3 = 'disabled';
                                $color = "";
                              ...
                              <tr <?php echo  $color; ?>>
                                ...
                                <td>
                                  <?php
                                      if(!empty($line->slip_photo)){?>
                                        <a href="uploads/<?php echo $line->slip_photo; ?>" download><img src="uploads/<?php echo $line->slip_photo; ?>" style="width: 30px; height: 30px; cursor: pointer;"></a>
                                      <?php } ?>
                                </td>
                                ...
                                <td>
                                 ...
                                 <td>
                                  <select name="company_id" id="company_id<?php echo $line->did ?>" onchange="ChangeInstituteData(this.value,<?php echo $line->did ?>,'company')" <?php echo $disabled1; ?>>
                                    <option value="">Select Company Name</option>
                                  <?php
                                  $isql = $obj->query("select * from $tbl_company where status=1");
                                  while($iResult = $obj->fetchNextObject($isql)){?>
                                ...
                                <td><?php echo $line->imp_remarks ?></td>                               
                                 ...
                                 <td>
                                    <select name="counsellor_status" id="counsellor_status<?php echo $line->did ?>" onchange="ChangeStudentData(this.value,<?php echo $line->did ?>,'counsellor_status')" <?php echo $disabled2; ?>>
      ...
      <script type="text/javascript">
        ...
        function ChangeInstituteData(fval,id,type){           
            $.ajax({
              ...
              success: function(data){                  
                  $("#counsellor_status"+id).removeAttr("disabled");
        ...
        function ChangeStudentData(fval,id,type){           
            $.ajax({
              ...
              success: function(data){
                  if(type=='counsellor_status' && fval==1){
                    $("#counsellor_status"+id).attr("disabled","disabled");
                    location.reload();
                  }else if(type=='counsellor_status' && fval==0){
                    location.reload();
                  }
              }
            });
