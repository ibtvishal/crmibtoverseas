            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12"> 
                        <h5 class="txt-dark">Reapplied Students
                        ...
                        <div class="panel panel-default card-view">
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                                <div class="col-md-2">Color Code: <span style="color:green">Enrolled</span></div>
                                            </div>
    ...
    <div id="invoiceModel" class="modal fade" role="dialog">
        ...
        <script type="text/javascript">
            ...
            var dataTable = $('#ApplicationList').DataTable({
                ...
                "ajax": {
                    url: "manage-reapply-fee-ajax.php",
                    type: "post",
                    error: function() {
